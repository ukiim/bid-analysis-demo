...
export default function AnalysisCalculator({ baseAmount, selectedRate }: Props) {
  ...
  return (
    <div className="mx-4 mt-3 mb-6 bg-white border border-gray-300">
      <div className="bg-gradient-to-b from-[#4A7ABF] to-[#3358A4] text-white px-4 py-2 text-[12px] font-bold">
        투찰금액 계산
      </div>
      <div className="p-4">
        <table className="border-collapse text-[12px]">
          <tbody>
            <tr>
              ...
              <td className="border border-gray-300 px-3 py-2 font-bold text-[#3358A4] text-[14px]">
